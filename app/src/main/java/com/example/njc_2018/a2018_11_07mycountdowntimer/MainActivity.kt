...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val layout = findViewById<ConstraintLayout>(R.id.ConstraintLayout)  // <- これも成功している
        //val layout = ConstraintLayout  // <- これも成功している
        //layout.addView(image[2]) // <- これも成功している
        ConstraintLayout.addView(image[2])  // <- これが最も簡潔で良い・・・ImageViewの追加
